...
SERIES_TITLE = "Linear Algebra in Python"
SERIES_SUBTITLE = "A Notebook Course in Matrices, Algorithms, and Learning"
AUTHOR = "Raymond Amador"

# Bumped by tools/bump_version.py / edited by hand; shown in every header.
SERIES_VERSION = "1.3.0"
...
def header(
    ...
    """
    if optional:
        difficulty = f"{difficulty} · optional capstone" if difficulty else "optional capstone"
    nb = Notebook(volume, number, title, blurb, difficulty, estimate)
